...
const MainTable = () => {
	...
	return (
		<div>
			...
			<div className="flex">
				<div className={`sidebar flex flex-col justify-between w-[500px] border-r-[1px] overflow-y-scroll scrollbar-none  ${colorTheme ? "bg-[#08312a]" : "bg-[#ffffff]"}`}>
					<div className={`h-[100vh] pl-[20px] pr-[40px] py-[40px]`}>
						<div>
							...
							<div className="pt-[20px]">
								{
									!columnId ? 
										<div className={`text-[14px] ${colorTheme ? "text-[#dbdbdb]" : "text-[#000000]"}`}>
				...
				<div className={`w-[100%] pt-[20px] pl-[50px] pr-[20px] h-[100vh] overflow-y-scroll ${colorTheme ? "bg-[#376251]" : "bg-[#ffffff]"}`}>
					<div className="mb-[20px]">
						<input 
							className={`${colorTheme ? "bg-[#08312a]" : "bg-[#f2f2f2]"} w-[100%] py-[10px] pr-[10px] pl-[20px] ${colorTheme ? "text-[#ffffff]" : "text-[#000000]"}`} type="text" placeholder="Enter Keyword" 
							value={searchTerm}
